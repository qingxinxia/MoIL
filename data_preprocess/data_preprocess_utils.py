...
def train_test_val_split(x_win_all, y_win_all, d_win_all, split_ratio=0.8):
    ...
    x_win_train, x_win_test, y_win_train, y_win_test, d_win_train, d_win_test = \
        train_test_split(x_win_all, y_win_all, d_win_all, test_size=split_ratio, random_state=0, shuffle=False)
    ...
    x_win_train, x_win_val, y_win_train, y_win_val, d_win_train, d_win_val = \
        train_test_split(x_win_train, y_win_train, d_win_train, test_size=split_ratio, random_state=0, shuffle=False)


    # # plt.plot(a[:1000])
    # b = y_win_test.reshape(-1)
    # plt.plot(b[:1000])
    # plt.savefig('aa.png')
